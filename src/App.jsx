  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/join-home"      element={<Placeholder name="Join Home" />} />
        <Route path="/create-home"    element={<Placeholder name="Create Home" />} />
        <Route path="/home-ready"     element={<Placeholder name="Join/Create Success" />} />
